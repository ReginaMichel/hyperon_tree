...
#ifndef AliAnalysisTaskHypertritonKFTreeLocal_H
#define AliAnalysisTaskHypertritonKFTreeLocal_H
...
class AliAnalysisTaskHypertritonKFTreeLocal : public AliAnalysisTaskSE
{
public:
  AliAnalysisTaskHypertritonKFTreeLocal();
  AliAnalysisTaskHypertritonKFTreeLocal(const char *name);
  virtual ~AliAnalysisTaskHypertritonKFTreeLocal();
  ...
  void SetBackground(Bool_t ActivateBackground) {kOnlyBackground = ActivateBackground;}; /// only for 3-body
...
private:
  ...
  Bool_t kOnlyBackground;         /// Wrong combination of daughters is used with correct total charge (only for 3-body)
  ...
  AliAnalysisTaskHypertritonKFTreeLocal(const AliAnalysisTaskHypertritonKFTreeLocal&); // not implemented
  AliAnalysisTaskHypertritonKFTreeLocal& operator=(const AliAnalysisTaskHypertritonKFTreeLocal&); // not implemented
  
  ClassDef(AliAnalysisTaskHypertritonKFTreeLocal, 1);
};
