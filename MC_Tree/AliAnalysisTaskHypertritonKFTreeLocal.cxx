...
void AliAnalysisTaskHypertritonKFTreeLocal::ProcessESD()
{
  ...
  if(kRun3BodyDecay){
    ...
    if (kOnlyBackground) {
      // only wrong combinations of charge but correct total charge
      ThreeBodyDecay(DeuteronCandTrackIdPos, ProtonCandTrackIdNeg, PionCandTrackIdPos);
      ThreeBodyDecay(DeuteronCandTrackIdNeg, ProtonCandTrackIdPos, PionCandTrackIdNeg);
      ThreeBodyDecay(DeuteronCandTrackIdNeg, ProtonCandTrackIdPos, PionCandTrackIdPos);
      ThreeBodyDecay(DeuteronCandTrackIdPos, ProtonCandTrackIdNeg, PionCandTrackIdNeg);
    } else{
...
///____________________________________________________________
void AliAnalysisTaskHypertritonKFTreeLocal::ThreeBodyDecay(const vector<Int_t>& DeuteronCandTrackId, const vector<Int_t>& ProtonCandTrackId, const vector<Int_t>& PionCandTrackId){
  ...
  for (unsigned int jProton=0; jProton < (UInt_t) ProtonCandTrackId.size(); jProton++) {
    ...
    for (unsigned int lDeuteron=0; lDeuteron < (UInt_t) DeuteronCandTrackId.size(); lDeuteron++) {
      ...
      /// preselection based on the mass (based on MC)
...
///____________________________________________________________
void AliAnalysisTaskHypertritonKFTreeLocal::ThreeBodyDecayMC(const vector<Int_t>& ESDTrackId, Int_t IdDeuteron, Int_t IdProton, Int_t IdPion){
...
///____________________________________________________________
Bool_t AliAnalysisTaskHypertritonKFTreeLocal::DeuteronSelection (AliESDtrack* track)  {
...
///____________________________________________________________
Bool_t AliAnalysisTaskHypertritonKFTreeLocal::ProtonSelection(AliESDtrack* track)  {
...
///____________________________________________________________
Bool_t AliAnalysisTaskHypertritonKFTreeLocal::DaughterSelection(){
  /// Put a preselection based on daughte rvariables here (2-body)
  
  return true;
}
///____________________________________________________________
Bool_t AliAnalysisTaskHypertritonKFTreeLocal::HypertritonCandidateSelection (KFParticle kfpMother, Bool_t TwoBody ){
...
///____________________________________________________________
Float_t AliAnalysisTaskHypertritonKFTreeLocal::CalculatePointingAngle(KFParticle KFPart, KFVertex KFVtx){
...
///____________________________________________________________
void AliAnalysisTaskHypertritonKFTreeLocal::FillDeuteronVariables (AliESDtrack* track, KFParticle KFPart){
...
///____________________________________________________________
void AliAnalysisTaskHypertritonKFTreeLocal::FillProtonVariables (AliESDtrack* track, KFParticle KFPart){
...
///____________________________________________________________
void AliAnalysisTaskHypertritonKFTreeLocal::FillDaughterVariables (KFParticle kfpDaughter1, KFParticle kfpDaughter2){
...
///____________________________________________________________
void AliAnalysisTaskHypertritonKFTreeLocal::FillDaughterVariables (KFParticle kfpDeuteron, KFParticle kfpProton, KFParticle kfpPion){
  /// three body decay
  /// expects:
...
///____________________________________________________________
void AliAnalysisTaskHypertritonKFTreeLocal::FillDistanceToSececondaryVertex(KFParticle kfpHelium, KFParticle kfpPion, KFParticle kfpMother){
...
///____________________________________________________________
void AliAnalysisTaskHypertritonKFTreeLocal::FillDistanceToSececondaryVertex(KFParticle kfpDeuteron, KFParticle kfpProton, KFParticle kfpPion, KFParticle kfpMother){
