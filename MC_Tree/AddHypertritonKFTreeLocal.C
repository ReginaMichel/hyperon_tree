...
AliAnalysisTaskHypertritonKFTreeLocal* AddHypertritonKFTreeLocal(UInt_t triggerMask= (AliVEvent::kINT7 | AliVEvent::kCentral | AliVEvent::kSemiCentral),
                                                                 Bool_t Run2Body=true,
                                                                 Bool_t Run3Body=true,
                                                                 Bool_t IsMC=false,
                                                                 Bool_t DoQA=false,
                                                                 Bool_t Backgroud = false
                                                                 )
{
  ...
  AliAnalysisTaskHypertritonKFTreeLocal* task = new AliAnalysisTaskHypertritonKFTreeLocal("TaskHypertriton");
  if(!task) return 0x0;
